---
chunk_id: course_scraping_with_google_sheets_001
...
---
 ...
 The `url` can be directly entered as a string or referenced from a cell containing the URL.)](https://youtu.be/eYQEk7XJM7s)
